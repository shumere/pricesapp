...
import { materialType, showEndCap } from "../../Reducer/buttonSlice.js";
import { cellContent } from "../../Functions/endCapCalculation.js";
import {
  tableValueForTheRow,
...
const EndCapTable = () => {
  ...
  let state2 = useSelector(showEndCap);
  ...
  const renderEndCapTable = () => {
    if (state2) {
      return (
        <div>
          <table>
            <caption>End cap</caption>
  ...
  return renderEndCapTable();
};

export default EndCapTable;
