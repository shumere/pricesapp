...
import { materialType, showSilencer } from "../../Reducer/buttonSlice";
import { cellContent } from "../../Functions/silencerCalculation";
import {
  tableValueForTheRow,
...
const SilencerTable = () => {
  ...
  let state2 = useSelector(showSilencer);
  ...
  const renderSilencerTable = () => {
    if (state2) {
      return (
        <div>
          <table>
            <caption>Silencer</caption>
  ...
  return renderSilencerTable();
};

export default SilencerTable;
